...
<body class="userSelect">
    ...
    <div class="projects-container dragCursor">
        ...
        <div id='home' class="project" data-project="home">
            <header>
                <div class="wave1">        
                ...
                <div id="header-content">
                    ...
                    <ul id="social">
                        <li>
                            <a id='twitter' href="https://twitter.com/LagierKevin" target="_blank">L</a>
                        </li><!--
                        !--><li>
                            <a id="behance" href="http://www.behance.net/KevinLagier" target="_blank">E</a>
                        </li><!--
                        !--><li>
                            <a id="dribbble" href="http://dribbble.com/kevlag" target="_blank">D</a>
                        </li><!--
                        !--><li>
                            <a id="linkedin" href="http://www.linkedin.com/profile/view?id=175237599&trk=hb_tab_pro_top" target="_blank">I</a>
                        </li>
                    </ul>
                </div>
                <div id="copyright">
        ...
        --><div id='theWholeProject' class="project" data-project="the-whole">
            <!-- <div>
                <p>
                    The Whole est une interface qui réuni des flux d'informations issus de sources variées et les présente sous la forme d'un mur d'informations.<br/>Ce projet présente la particularité de la mise en place d'un système d'unification des APIs.
                </p>       
                <img src="assets/img/the-whole/bg/the-whole-space.svg" alt="Social Coke"> 
            </div> -->
        </div><!--
