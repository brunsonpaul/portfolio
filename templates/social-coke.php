        ...
        <div class="page-content">
            ...
            <ul>
                ...
                !--><li>
                    ...
                    <a href='https://twitter.com/lo_denis' target='_blank'>L</a>
                    Développement<br/>(Php/Javascript)
                </li><!--
                !--><li>
                    <a href='http://mariongeorges.com/' target='_blank'>Marion Georges</a>
                    <a href='https://twitter.com/MarionGeorges_' target='_blank'>L</a>
                ...
                !--><li>
                    ...
                    <a href='https://twitter.com/mahedou' target='_blank'>L</a>
                    Design, typographie<br/>illustration
                </li>
            </ul>
        </div>
        <img id='poisson' src='./assets/img/social-coke/poisson.svg' alt=''>                  
    </article>
